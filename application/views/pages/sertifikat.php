              ...
              <div class="card">
                  ...
                  <?php if(isset($first_name)) :?>
                      <div class="text-center mt-4 mb-4">
                          <a href="javascript:void()"><img src="<?= $link['value']?>/assets/img/logo.png?t=<?= time()?>" alt="" class="img-fluid" style="max-height: 60px"></a>
                      </div>
                      <div class="mb-2 mt-3">
                      <h5 class="m-0 font-weight-bold text-dark">No. Sertifikat : </i>I.<?= $no_doc?><?= $hari?><?= $bulan?><?= $tahun?></h5><br>
                      <p>
